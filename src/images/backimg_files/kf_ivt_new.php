	...
	function hz6d_cus_web_msg_open(){
		var openurl = "https://www5.53kf.com/webCompany.php?kf_sign=zE0OTMTU3Ng2NjEwMjgxNTk5ODY0MDE3NzIyMDkyMTI=&arg=10209212&style=1&kflist=off&kf=2466467939%40qq.com%2C1334323999%40qq.com%2C631475922%40qq.com&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=GBK&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fwww.gazkyy.cn%2F&keyword=&brief=&logo=&question=&uid=660f8ff957c77b5cc5bca3323cd3277b";
		try{
...
//	hz6d_get_guest_id_timer = setTimeout("hz6d_get_guest_id()", 500);
	...
	//	var acc_poptype				= -1;
		...
		var pc_ivt_top = "40";
		var pc_ivt_left = "50";
		var callback_id6ds = "10359760,10359761,10359789";
		...
		if ((pc_ivt_type == '2' || pc_ivt_type == '-1') && 0 == '0') {
			...
			Inv.prototype = {
				...
				talk : function(){
					...
					if (zdfq_type == 3) {
						...
						var openurl = "https://www5.53kf.com/webCompany.php?kf_sign=zE0OTMTU3Ng2NjEwMjgxNTk5ODY0MDE3NzIyMDkyMTI=&arg=10209212&style=1&kflist=off&kf=2466467939%40qq.com%2C1334323999%40qq.com%2C631475922%40qq.com&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=GBK&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fwww.gazkyy.cn%2F&keyword=&brief=&logo=&question=&uid=660f8ff957c77b5cc5bca3323cd3277b&tfrom=2" + force_kf;
						onliner_zdfq=2;
			...
			tmp_innerHTML += '<div id="iframe_company_mini_div" style="'+mini_div_display+'font-size: 0;background-color:#fff;border-radius:2px;overflow:hidden;width:100%;height:'+mini_size_height+'px;box-shadow:0 5px 40px rgba(0,0,0,.16)!important;-webkit-box-shadow:0 5px 40px rgba(0,0,0,.16)!important;">'+
								'<h6 class="pc-visitor-header" style="width:100%;box-sizing:border-box;background: '+minicolor_tbbj+' no-repeat 10px;margin:0;padding:0;padding-left: 10px;font-size: 14px;color: #fff;height: 36px;line-height: 36px;position: relative;font-weight: normal;padding-right: 72px;">'+
									'<img style="max-width: 80px;width:auto;height:24px;float: left;margin-top: 6px;border-radius:2px;" src="https://www5.53kf.com/img/upload/10209212/mobile/temp/mobile_53kf_1569381492.png"/>'+
	...
	function show_floatWindow(type){//type:  zdfq:主动发起规则打开  qzzk:强制展开打开   不传:用户点击展开
		...
		try{
			...
			if (navigator.userAgent.indexOf("Firefox") > -1){
				document.getElementById('iframe_company_mini').contentWindow.postMessage('openMini',"https://www5.53kf.com/webCompany.php?kf_sign=zE0OTMTU3Ng2NjEwMjgxNTk5ODY0MDE3NzIyMDkyMTI=&arg=10209212&style=1&kflist=off&kf=2466467939%40qq.com%2C1334323999%40qq.com%2C631475922%40qq.com&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=GBK&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fwww.gazkyy.cn%2F&keyword=&brief=&logo=&question=&uid=660f8ff957c77b5cc5bca3323cd3277b&tfrom=2");
			}
	...
	{
		if(zdfq_switch == 'yes') {
			//document.cookie = "onliner_zdfq72209212="+onliner_zdfq;
			document.cookie = "my_acc_reauto_time=" + new Date().getTime() + ";path=/";
		} else {
			document.cookie = "my_acc_reauto_time=null;path=/";
		}
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
				...
				if (open_mini_windown == '1' && "jh" == 'www111'){//品房阁需求 处理
					if (force_kf != '') {
						...
						if (workerid != '') {
							...
							try{
								document.getElementById('iframe_company_mini').contentWindow.postMessage(lnk_msg,"https://www5.53kf.com/webCompany.php?kf_sign=zE0OTMTU3Ng2NjEwMjgxNTk5ODY0MDE3NzIyMDkyMTI=&arg=10209212&style=1&kflist=off&kf=2466467939%40qq.com%2C1334323999%40qq.com%2C631475922%40qq.com&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=GBK&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fwww.gazkyy.cn%2F&keyword=&brief=&logo=&question=&uid=660f8ff957c77b5cc5bca3323cd3277b&tfrom=2");
							}catch(e){}
						}
					}
					return;
	...
	function close_company_mini(){
		...
		// if(acc_autotype == 3) {onliner_zdfq = 3;document.cookie = "onliner_zdfq72209212="+onliner_zdfq;}
	...
	function ivt_seturl(zdy_yqk)
	{
		var divs_str = zdy_yqk.replace(/operating="([^"]*)"/g,function(str){
			...
			if(vals[1])
			{
				...
				{
					case 'KF':
						var click_open_url = 'window.open(\"https://www5.53kf.com/webCompany.php?kf_sign=zE0OTMTU3Ng2NjEwMjgxNTk5ODY0MDE3NzIyMDkyMTI=&arg=10209212&style=1&kflist=off&kf=2466467939%40qq.com%2C1334323999%40qq.com%2C631475922%40qq.com&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=GBK&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fwww.gazkyy.cn%2F&keyword=&brief=&logo=&question=&uid=660f8ff957c77b5cc5bca3323cd3277b&tfrom=2\",\"_blank\",\"height=600,width=800,top=50,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\")';
						...
						break;
						//click_str ='onliner_zdfq=2;get_open_start();window.open(\"https://www5.53kf.com/webCompany.php?kf_sign=zE0OTMTU3Ng2NjEwMjgxNTk5ODY0MDE3NzIyMDkyMTI=&arg=10209212&style=1&kflist=off&kf=2466467939%40qq.com%2C1334323999%40qq.com%2C631475922%40qq.com&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=GBK&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fwww.gazkyy.cn%2F&keyword=&brief=&logo=&question=&uid=660f8ff957c77b5cc5bca3323cd3277b&tfrom=2\",\"_blank\",\"height=473,width=703,top=200,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\");hidden_ivt();';break;
					case 'CLOSE':
						click_str = 'onliner_zdfq=3;jtfq_type=1;hidden_ivt();'; break;
					case 'ETEL':
						click_str = 'window.open(\'https://tb.53kf.com/eht.php?company_id=72209212&style_id=106512966\',\'_blank\',\'height=400,width=300,top=100,left=200,status=yes,toolbar=no,menubar=no,resizable=no,scrollbars=no,location=no,titlebar=no\')';break;
					case 'QQ':
						if(valst[1]){
